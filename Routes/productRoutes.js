...
const { deleteProduct, updateProduct, getProducts, createProduct, getProductById, createMultiProduct } = require('../Controller/productController');
...
productRoutes.post('/api/v1/add-multi-product', createMultiProduct);
